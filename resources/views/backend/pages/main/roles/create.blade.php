        ...
        <div class="col-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h6 class="m-b-0 text-white">Create Role</h6>
                </div>
                            ...
                            <div class="col col-md-12">
                                ...
                                <form class="form-material" id="addForm">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control" autocomplete="off" placeholder="Role Name">
                                            </div>
                                    ...
                                    <div class="row row-border">
                                        ...
                                        <input type="checkbox" id="item_{{$permission->id}}" value="{{ $permission->name }}" class="filled-in" name="permissions[]" 
